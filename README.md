...
Курсовая работа 3 - это проект, целью которого 
является: получить данные о компаниях и вакансиях с сайта hh.ru, спроектировать таблицы в БД PostgreSQL и загрузить полученные данные в созданные таблицы.
## Установка:

Клонируйте репозиторий:
```
git clone https://github.com/Rustam-7-7-7/K.R.3.git
```
Создайте в корне проекта файл database.ini со следующим содержимым: 
...
и замените многоточия реальными данными.
